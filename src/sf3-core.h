...
typedef struct sf3_str8{
  uint8_t length;
  char str[];
} sf3_str8;

typedef struct sf3_str16{
  uint16_t length;
  char str[];
} sf3_str16;

typedef struct sf3_str32{
  uint32_t length;
  char str[];
} sf3_str32;

typedef struct sf3_str64{
  uint64_t length;
  char str[];
} sf3_str64;
...
int sf3_check_identifier(const struct sf3_identifier *identifier){
